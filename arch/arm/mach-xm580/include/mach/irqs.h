...
#define DMAC_IRQ		(XM580_GIC_IRQ_START + 10)
#define GMAC_IRQ		(XM580_GIC_IRQ_START + 3)

#define SDIO0_IRQ		(XM580_GIC_IRQ_START + 41)
#define SDIO1_IRQ		(XM580_GIC_IRQ_START + 42)

#define NR_IRQS			(XM580_GIC_IRQ_START + 96)
